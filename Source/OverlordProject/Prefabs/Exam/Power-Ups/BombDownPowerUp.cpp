#include "stdafx.h"
#include "BombDownPowerUp.h"
#include "Materials/Shadow/DiffuseMaterial_Shadow.h"
#include "Prefabs/Exam/Player/Player.h"
#include "Components/PlaceBombComponent.h"

BombDownPowerUp::BombDownPowerUp(const std::wstring& model, const std::wstring& texture)
{
...
void BombDownPowerUp::Use(Player* pPlayer)
{
	if (!pPlayer) return;
	...
	pPlaceBombComponent->DecreaseBombs();
}
